...
/**
 * Request DTO for creating or updating an equipment category in the taxonomy hierarchy.
 * <p>
 * This record encapsulates category details including optional hierarchical parent linking.
 * Categories support multi-level hierarchies (e.g., Protective Gear → Helmets → Full Face).
 * </p>
 * 
 * Field Constraints:
 * <ul>
 ...
 * 
 * @param name the category name (e.g., "Helmets", "Protective Gear")
