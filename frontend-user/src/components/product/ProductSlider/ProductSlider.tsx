...
/**
 * Horizontal carousel of `ProductCard` items with responsive columns, arrows, dots, autoplay, and touch swipe.
 *
 * @param props.products - Slides to render (cloned internally for infinite loop)
 * @param props.autoplay - When true, advances on an interval unless paused
 * @param props.autoplayDelay - Interval in ms between autoplay steps
 * @param props.onAddToCart - Forwarded to each `ProductCard`
 */
